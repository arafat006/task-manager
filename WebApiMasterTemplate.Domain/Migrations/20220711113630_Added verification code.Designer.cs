...
namespace WebApiMasterTemplate.Domain.Migrations
{
    ...
    [Migration("20220711113630_Added verification code")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApiMasterTemplate.Domain.DbModels.VerificationCode", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 11, 11, 36, 30, 797, DateTimeKind.Utc).AddTicks(7012));
            ...
            modelBuilder.Entity("WebApiMasterTemplate.Domain.DbModels.VerificationCode", b =>
                {
                    b.HasOne("WebApiMasterTemplate.Domain.DbModels.User", "User")
                        ...
                        .HasForeignKey("WebApiMasterTemplate.Domain.DbModels.VerificationCode", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
