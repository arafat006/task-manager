...
namespace WebApiMasterTemplate.Domain.Migrations
{
    ...
    [Migration("20220711134621_Change verification table name")]
    partial class Changeverificationtablename
    {
            ...
            modelBuilder.Entity("WebApiMasterTemplate.Domain.DbModels.Verification", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 11, 13, 46, 21, 386, DateTimeKind.Utc).AddTicks(3131));
